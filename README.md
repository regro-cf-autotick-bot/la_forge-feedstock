...
Once the `conda-forge` channel has been enabled, `la_forge` can be installed with:

```
conda install la_forge
```

It is possible to list all of the versions of `la_forge` available on your platform with:
